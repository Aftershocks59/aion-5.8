...
public class FissureOfOblivionInstance extends GeneralInstanceHandler
{
	...
	public void onEnterInstance(final Player player) {
		...
		SkillEngine.getInstance().applyEffectDirectly(4831, player, player, 1800000 * 1); //Ancient High DaevaÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s Memory.
	}
	...
	private void removeEffects(Player player) {
		...
		effectController.removeEffect(4831); //Ancient High DaevaÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s Memory.
		effectController.removeEffect(4834); //Ancient High DaevaÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s Memory.
		effectController.removeEffect(4835); //Ancient High DaevaÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s Memory.
		effectController.removeEffect(4836); //Ancient High DaevaÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s Memory.
    }
